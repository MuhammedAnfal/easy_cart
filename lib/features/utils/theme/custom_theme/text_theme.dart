...
class AppTextTheme{
  ...
  static TextTheme lightTheme =TextTheme(
    ...
    bodyLarge: const TextStyle(fontSize:14.0 ,fontWeight: FontWeight.w600,color: Colors.black),
    bodyMedium: const TextStyle(fontSize: 14.0,fontWeight: FontWeight.normal,color: Colors.black),
    bodySmall: TextStyle(fontSize: 14.0,fontWeight: FontWeight.w600,color: Colors.black.withOpacity(0.5)),
  ...
  static TextTheme darkTheme = TextTheme(
    ...
    bodyLarge: const TextStyle(fontSize: 14.0,fontWeight: FontWeight.w600,color: Colors.white),
    bodyMedium: const TextStyle(fontSize:14.0 ,fontWeight: FontWeight.normal,color: Colors.white),
    bodySmall: TextStyle(fontSize: 14.0,fontWeight: FontWeight.w600,color: Colors.white.withOpacity(0.5)),
