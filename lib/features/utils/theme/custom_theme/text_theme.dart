...
class AppTextTheme{
  ...
  static TextTheme lightTheme =TextTheme(
    ...
    bodyLarge: TextStyle(fontSize:14.0 ,fontWeight: FontWeight.w600,color: Colors.black),
  ...
  static TextTheme darkTheme = TextTheme(
    ...
    bodyLarge: TextStyle(fontSize: 14.0,fontWeight: FontWeight.w600,color: Colors.white),
